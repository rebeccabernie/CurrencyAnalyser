...
CURR_NAMES = ['Bitcoin', 'Australian Dollar', 'Canadian Dollar', 'Swiss Franc', 'Chinese Yuan', 'British Pound', 'Hong Kong Dollar', 'Indian Rupee', 'Japanese Yen', 'South Korean Won', 'US Dollar', 'South African Rand']